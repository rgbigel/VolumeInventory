...
- Update header metadata in src/Get-VolumeInventory.ps1 when behavior changes.
- Add an entry to docs/CHANGELOG.md.
- Keep tests in tests/Get-VolumeInventory.Tests.ps1 aligned with script parameters and contract.
